...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['id']) && !isset($_POST['bulk_delete'])) {
    ...
    $stmt->bind_param(
        "ssssssssssssss",
        $_POST['department_id'], $_POST['ename'], $_POST['dob'], $_POST['gender'],
        $_POST['email'], $country_code, $_POST['pnumber'], $_POST['address'],
        $_POST['designation'], $currency, $_POST['salary'], $_POST['joining_date'], $_POST['aadhar'], $id
    );
    $stmt->execute();
    $stmt->close();
    header("Location: get.php");
            ...
            <table>
                ...
                <tbody id="tableData">
                    ...
                    <tr id="no-search-row" style="display:none;">
                        <td colspan="13" style="text-align:center; padding: 20px;">No employees found matching your search.</td>
                    </tr>
                </tbody>
            </table>
            <?php if ($totalRows > 0): ?>
...
<?php endif; ?>
    ...
    <div class="delete-overlay" id="delete-overlay">
        <div class="delete-modal">
            ...
            <div class="delete-title">Delete Employees?</div>
            <div class="delete-text" id="delete-emp-text">Are you sure you want to delete the selected employees?</div>
    ...
    <script>
        ...
        function showBulkDeleteModal() {
            ...
            if (count === 1) {
                ...
                deleteText.textContent = `Are you sure you want to delete these ${count} employees: ${selectedNames.join(', ')}? This action cannot be undone.`;
            } else {
                deleteText.textContent = `Are you sure you want to delete ${count} employees? This action cannot be undone.`;
            }

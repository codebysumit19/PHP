...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['id']) && !isset($_POST['bulk_delete'])) {
    ...
    $stmt->bind_param("sssssssss", $department_id, $pname, $cname, $pmanager, $sdate, $edate, $status, $pdescription, $id);
    $stmt->execute();
    $stmt->close();
    header("Location: get.php");
    exit;
                ...
                <tbody id="tableData">
                    ...
                    if ($result && $result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr class='data-row' data-id='{$id}' data-name='{$pname}'>";
                    ...
                    <tr id="no-search-row" style="display:none;">
                        <td colspan="10" style="text-align:center; padding: 20px;">No projects found matching your search.</td>
                    </tr>
                </tbody>
            </table>
            <?php if ($totalRows > 0): ?>
...
<?php endif; ?>
    ...
    <div class="delete-overlay" id="delete-overlay">
        <div class="delete-modal">
            ...
            <div class="delete-title">Delete Projects?</div>
            <div class="delete-text" id="delete-proj-text">Are you sure you want to delete the selected projects?</div>
    ...
    <script>
        ...
        function showBulkDeleteModal() {
            ...
            if (count === 1) {
                ...
                deleteText.textContent = `Are you sure you want to delete these ${count} projects: ${selectedNames.join(', ')}? This action cannot be undone.`;
            } else {
                deleteText.textContent = `Are you sure you want to delete ${count} projects? This action cannot be undone.`;
            }
